...
$sobAnalise = ("SELECT nome FROM DocumentosLab.users;");
...
<html class="ls-theme-orange">
  ...
  <div class="ls-notification-topbar">
    ...
    <div class="ls-alerts-list">
        <a href="AdmFuncionario.php" class="ls-ico-spinner" data-counter="8" data-ls-module="topbarCurtain" data-target="#ls-notification-curtain"><span>Atualizar Página</span></a>
 ...
 <li><a href="/locawebstyle/documentacao/exemplos/painel1/clients" class="ls-ico-circle-left" title="Painel Principal">Painel de Acompanhamento</a></li>
      ...
      <div class="container-fluid">
        <h1 class="ls-title-intro ls-ico-folder-open">Funcionários</h1>
        <div class="ls-list">
<?php
        if($total != 0){
          ...
          echo"<div class='ls-list'> 
               ...
               <a href='ValidaDoc.php' class='ls-btn-primary'>Administrar</a>
                  ...
                  $_SESSION['funcionario'] = $analise['nome'];          
    }  }?> 
  </header>
</div>
