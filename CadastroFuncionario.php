...
<html class="ls-theme-orange">
  ...
  <a href="PainelRh.php"  class="ls-go-next"><span class="ls-text">Adciona Funcionario</span></a>
  ...
  <div class="ls-sidebar-inner">
      ...
      <div class="container-fluid">
        <h1 class="ls-title-intro ls-ico-user-add">Adicionar Usuário</h1>

       
        <div class="ls-box ls-lg-space ls-ico-user-add ls-ico-bg">
  <h1 class="ls-title-1 ls-color-theme">Cadastre o novo funcionário!</h1>
  <p>Comece agora: cadastre abaixo o novo funcionário aprovado, crie um usuário e uma senha.</p>
</div>

        <form   method="post" action="AddUsu.php">
  ...
  <fieldset>
    ...
    <div class="ls-label col-md-5">
      <p>Escolha um dos cargos:</p>
      <label class="ls-label-text">
          <input type="radio" name="cargo" value="R.H">
        Agente R.H
      </label>
      <label class="ls-label-text">
          <input type="radio" name="cargo"value="outros">
        Outros
      </label>
    </div>
  </fieldset>
  <div class="ls-actions-btn">
   <input class="ls-btn-primary ls-ico-bukets" id="btnenviar" name="btnenviar" type="submit" value="  Adicionar usuário  " />
