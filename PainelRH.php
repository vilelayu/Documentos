...
<html class="ls-theme-orange">
  ...
  <a href="/locawebstyle/documentacao/exemplos//pre-painel"  class="ls-go-next"><span class="ls-text">Painel de acompanhamento</span></a>
  ...
  <div class="ls-sidebar-inner">
      ...
      <nav class="ls-menu">
        <ul>
            <li><a href="CadastroFuncionario.php" class="ls-ico-user-add" title="Clientes">Adicionar Funcionário</a></li>
            <li><a href="AdicionarDocumento.php" class="ls-ico-docs" title="Clientes">Adicionar Documentos</a></li>
  </div>
</aside>
...
---------------------------------------------------------------- PÁGINA INICIAL-----------------------------------------------------------------
    <main class="ls-main ">
      <div class="container-fluid">
        <h1 class="ls-title-intro ls-ico-folder-open">Painel de Acompanhamento</h1>

        <div class="ls-list">
           <header class="ls-list-header">
        <div class="ls-list-title col-md-9">
           <a href="#" >Funcionarios</a>
          <small> Localize o funcionarios e as documentações enviadas</small>
        </div>
    <div class="col-md-3 ls-txt-right">
        <a href="AdmFucionario.php" class="ls-btn-primary">Administrar</a>
    </div>
  ...
  <header class="ls-list-header">
    <div class="ls-list-title col-md-9">
      <a href="#" >Gerenciamento documentações enviadas </a>
      <small> Verifique  o Status das documentações  </small>
    </div>
    <div class="col-md-3 ls-txt-right">
        <a href="GerenciaDoc.php" class="ls-btn-primary">Administrar</a>
    </div>
  </header>
</div>
          <div class="ls-list">
  <header class="ls-list-header">
    <div class="ls-list-title col-md-9">
      <a href="#" >Relação documentação</a>
      <small> Verifique os documentos pedidos aos funcionarios  </small>
    </div>
    <div class="col-md-3 ls-txt-right">
        <a href="relacaoDoc.php" class="ls-btn-primary">Administrar</a>
    </div>
  </header>
</div>
